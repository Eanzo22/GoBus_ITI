...
namespace BL.Managers.PublicActivityManagers
{
    public class PublicActivityManager : IPublicActivityManager
    {
        ...
        #region UpdateAsync
        public async Task<Response> UpdateAsync(int id, PublicActivityAddDto publicActivityUpdateDto)
        {
        ...
        public async Task<Response> GetByIdAsync(int id)
        {
            ...
            return _unitOfWork.Response(false, null, $"There is no public Activity With id ({id})");
