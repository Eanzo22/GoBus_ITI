    ...
    public async Task<Response> RegisterAsync(RegisterDto registerDto)
    {
        ...
        if (!errors.Any())
        {
            ...
            if (applicationUser is not null && applicationRole is not null)
            {
                ...
                if (ressult)
                {
                    return _unitOfWork.Response(true, null, $"UserName with Id ({applicationUser.Id}) has been assigned to Role ({applicationRole.Name})");
                }
                return _unitOfWork.Response(true, null, $"UserName with Id ({applicationUser.Id}) has been Added but not assigned to Role ({applicationRole.Name})");
            }
    ...
    public async Task<Response> RegisterDriverAsync(RegisterDto registerDto)
    {
        ...
        if (!errors.Any())
        {
            ...
            if (applicationUser is not null && applicationRole is not null)
            {
                ...
                if (ressult)
                {
                    return _unitOfWork.Response(true, null, $"Driver has been assigned to Role ({applicationRole.Name})");
                }
                return _unitOfWork.Response(true, null, $"Driver has been Added but isn't assigned to Role ({applicationRole.Name})");
            }
    ...
    public async Task<Response> RegisterAdminAsync(RegisterDto registerDto)
    {
        ...
        if (!errors.Any())
        {
            ...
            if (applicationUser is not null && applicationRole is not null)
            {
                ...
                if (ressult)
                {
                    return _unitOfWork.Response(true, null, $"Admin has been assigned to Role ({applicationRole.Name})");
                }
                return _unitOfWork.Response(true, null, $"Admin has been Added but not assigned to Role ({applicationRole.Name})");
            }
